  ...
  function verificarRegulacionesContraseña() {
    ...
    const botonRegistrar = document.querySelector('.btnRegistrar-auth');
    ...
    if (checkmarks[0].style.display === 'block' && checkmarks[1].style.display === 'block' && checkmarks[2].style.display === 'block') {
